 ...
 */
class CompanyUpdateUrlAlias extends FormBase {
  ...
  public function getFormId() {
    return 'company_update_url_alias';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $form['company_update'] = [
      '#type' => 'submit',
      '#value' => $this->t('Update Url alias for Companies'),
    ];
    return $form;
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    $batch = [
      'title' => t('Updating Company Url alias...'),
      'operations' => [
        ['\Drupal\redbook_pcl_custom\Form\CompanyUpdateUrlAlias::updateUrlAlias', []],
      ],
      'finished' => '\Drupal\redbook_pcl_custom\Form\CompanyUpdateUrlAlias::finishedCallback',
   ...
   */
  public function updateUrlAlias(&$context) {
    ...
    foreach ($company_ids as $entity_rev_id => $entity_id) {
      ...
      if (!empty($node)) {
        ...
        $additional_alias = '/company/' . $pin;
        $langcode = \Drupal::languageManager()->getCurrentLanguage()->getId();
        $aliasStorage->save('/node/' . $entity_id, $additional_alias, $langcode);
      }
    }
